...
<div class="voyage-create-page">
    <div class="page-title">
        ...
        <p class="page-subtitle">Mettez a jour les informations du trajet.</p>
    </div>

    <div class="voyage-form-card search-form-bg">
        <?php $form = ActiveForm::begin([
            'id' => 'voyage-update-form',
            'method' => 'post',
            'options' => [
        ...
        <div class="form-actions">
            <?= Html::submitButton('Enregistrer les modifications', ['class' => 'btn-save']) ?>
